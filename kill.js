...
const RESTART_DELAY = 1000;
 ...
 if (cluster.isMaster) {
  console.clear()
  console.log(`Attack Successfully Sent By @ThanhBaoo`.brightBlue)
  console.log(`--------------------------------------------`.gray)
  ...
  console.log(` - Owner      : `.brightRed + "@ThanhBaoo")
  console.log(`--------------------------------------------`.gray)
  console.log(`http-kill with high rq/s killed your hard targets.`.brightCyan)
    const restartScript = () => {
