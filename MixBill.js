...
const url = require("url");
 ...
 if (process.argv.length < 5){console.log(`
        CARA RUN= node MixBill url time 64 8 proxy.txt
`); process.exit();}
...
const secureOptions = 
 ...
 const sigalgs = "ecdsa_secp256r1_sha256:rsa_pss_rsae_sha256:ecdsa_secp384r1_sha384:rsa_pss_rsae_sha384:ecdsa_secp521r1_sha512:rsa_pss_rsae_sha512";
 
 const ecdhCurve = "GREASE:x25519:x448:secp256r1:secp521r1";
...
`);
 ...
 headers["accept"] = "text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,image/svg+xml,*/*;q=0.8";
...
/*method by billz lulzsec/proton service*/
/*successfully update by Mrcyber 27102024*/